...
Эта карточка - risk-boundary по теме "SolidarTrading - первый шаг от 12 до 118 процентов в месяц". RAG должен сохранять ограничения и не превращать рискованные формулировки в доказанное обещание.
