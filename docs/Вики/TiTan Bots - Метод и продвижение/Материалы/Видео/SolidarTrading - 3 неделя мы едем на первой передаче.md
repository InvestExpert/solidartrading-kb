...
Эта карточка - risk-boundary по теме "SolidarTrading - 3 неделя мы едем на первой передаче". RAG должен сохранять ограничения и не превращать рискованные формулировки в доказанное обещание.
